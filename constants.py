...
EXPERIMENTS = {
    ...
    "金属-陶瓷结合裂纹萌生试验": {
        ...
        "kind": "mc", "n": 6,
        "template": "金属-陶瓷结合特性三点弯曲试验_CMA原始记录表_夹具平行块增强版.docx",
        "sop": "金属-陶瓷结合裂纹萌生试验SOP_CMA版.docx"
    },
    "金属内部质量X射线灰度分析": {
    ...
    "翘曲变形试验": {
        ...
        "kind": "warp", "n": 10,
        "template": "翘曲变形试验原始记录表.docx",
        "sop": "附件A_二次元影像测量示意图.docx"
    },
    "热膨胀系数试验": {
    ...
    "陶瓷牙耐急冷急热试验": {
        ...
        "kind": "shock", "n": 28,
        "template": "陶瓷牙耐急冷急热性能试验_CMA原始记录表_副本.docx",
        "sop": "陶瓷牙耐急冷急热性能试验SOP_CMA版.docx"
    },
    "弯曲性能试验": {
    ...
    "增材制造金属试样厚度测量": {
        ...
        "kind": "thickness", "n": 5,
        "template": None,
        "sop": "YYT1702-2020_增材制造金属试样厚度测量_二次元影像法SOP_CMA版.docx"
    },
    "牙科材料色稳定性试验": {
