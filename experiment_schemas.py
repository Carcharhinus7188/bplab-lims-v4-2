...
COMMON_ENV_FIELDS = [
    {"key": "temperature", "label": "环境温度/℃", "type": "number", "default": 23.0},
    {"key": "humidity", "label": "相对湿度/%RH", "type": "number", "default": 50.0},
    {"key": "detection_location", "label": "检测地点", "type": "text", "readonly": True},
    {"key": "start_time", "label": "实验开始时间", "type": "datetime"},
    {"key": "end_time", "label": "实验结束时间", "type": "datetime"},
...
SCHEMAS = {
    "rough": {
        ...
        "sections": [
            ...
            {"title": "试验参数与使用前确认", "fields": [
                {"key": "standard_block", "label": "标准粗糙度样板编号/标称值", "type": "text"},
                ...
                {"key": "measurement_direction", "label": "测量方向", "type": "text"},
            ]},
        ],
        "columns": [
            ("sample_no", "试样编号", "text"), ("position", "测量位置", "text"),
    ...
    "mc_crack": {
        ...
        "columns": [
            ...
            ("dm_mean", "金属厚度平均/mm", "calc"), ("em", "金属弹性模量/GPa", "number"), ("k", "K/mm⁻²", "number"),
            ("ffail", "裂纹萌生力/N", "number"), ("tau", "结合强度/MPa", "calc"),
            ("crack_position", "裂纹位置及形态", "text"), ("curve_no", "曲线/数据文件编号", "text"),
    ...
    "xray": {
        ...
        "columns": [
            ...
            ("image_no", "图像文件编号", "text"), ("image_valid", "图像有效性", "select:有效|无效"),
            ("iqi_display", "像质计显示", "select:清晰|不清晰"),
            ("roi1", "ROI-1灰度", "number"), ("roi2", "ROI-2灰度", "number"), ("roi3", "ROI-3灰度", "number"),
    ...
    "shock": {
        ...
        "columns": [
            ("sample_no", "样品编号/位置", "text"), ("crack", "裂纹", "select:无|有"),
    ...
    "hv": {
        ...
        "columns": [
            ...
            ("conclusion", "单样结论", "text"), ("image_no", "压痕图像编号", "text"), ("note", "备注", "text"),
        ],
    },
    "thickness": {
        "title": "增材制造金属试样厚度测量",
        "sections": [
            ...
            {"title": "影像测量参数", "fields": [
                ...
                {"key": "repeat_count", "label": "每点重复测量次数", "type": "number", "default": 2.0},
                {"key": "image_path", "label": "原始测量图像路径", "type": "text"},
            ]},
        ],
        "columns": [
            ("sample_no", "试样编号", "text"), ("fixed1", "固定端1/mm", "number"), ("fixed2", "固定端2/mm", "number"),
            ("middle1", "中点1/mm", "number"), ("middle2", "中点2/mm", "number"),
            ("free1", "自由端1/mm", "number"), ("free2", "自由端2/mm", "number"),
            ("mean", "平均厚度/mm", "calc"), ("limit", "判定要求/mm", "text"),
